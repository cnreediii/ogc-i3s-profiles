...
|id |integer|Unique numeric ID of the layer. |Yes
|href|string |The relative URL to the 3DSceneLayerResource. Only present as part of the SceneServiceInfo resource. | optional
|layerType |string |The user-visible layer type. Must be: Point |One (mandatory)
|===
